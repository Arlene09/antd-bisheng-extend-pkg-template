...
var DModal = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(DModal, _React$PureComponent);

  var _super = _createSuper(DModal);

  function DModal(props) {
    var _this;

    _classCallCheck(this, DModal);
  ...
  _createClass(DModal, [{
    ...
    value: function render() {
      ...
      var modalProps = Object.assign(Object.assign({}, this.props), {
        confirmLoading: confirmLoading,
        visible: true,
        onOk: this.handleOk,
        onCancel: this.handleCancel
      });
      return /*#__PURE__*/_react["default"].createElement("div", null, this.state.visible && /*#__PURE__*/_react["default"].createElement(_antd.Modal, Object.assign({}, modalProps), this.props.children));
    }
  }]);
