...
function (_React$PureComponent) {
  ...
  function CodePreview(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CodePreview).call(this, props));
    _this.state = {
      codeExpand: true
    };
    _this.codeCon = _react["default"].createRef();
    _this.handleCodeExpand = _this.handleCodeExpand.bind(_assertThisInitialized(_this));
    _this.fullscreenPreview = _this.fullscreenPreview.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(CodePreview, [{
    ...
    value: function render() {
      ...
      var codeExpand = this.state.codeExpand;
      var codePreviewClass = codeExpand ? 'code-preview' : 'code-preview-expand';
