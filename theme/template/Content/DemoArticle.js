...
function (_React$PureComponent) {
  ...
  function DemoArticle(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DemoArticle).call(this, props));
    _this.state = {
      isWide: true
    };
    _this.getDemoComponent = _this.getDemoComponent.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(DemoArticle, [{
    ...
    value: function getDemoComponent(pageData) {
      ...
      return Object.keys(pageData.demo).map(function (key) {
        ...
        return _react["default"].createElement(_DemoItem["default"], demoProps, shouldPreviewDemo ? item.preview(_react["default"], _reactDom["default"]) : null);
      });
    ...
    value: function render() {
      ...
      }, toReactComponent(content)), demoComponent && _react["default"].createElement("div", {
        className: "demo-wrapper"
      }, demoComponent), api && _react["default"].createElement("div", {
        className: "page-api markdown"
      }, toReactComponent(api), changelog && _react["default"].createElement("div", {
        className: "page-content markdown"
      }, toReactComponent(changelog))), !toc || toc.length <= 1 || disableToc ? null : _react["default"].createElement("section", {
        className: "toc"
