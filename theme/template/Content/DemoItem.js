...
function (_React$PureComponent) {
  ...
  function DemoItem(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DemoItem).call(this, props));
    _this.state = {
      intoViewport: true
    };
    return _this;
  ...
  _createClass(DemoItem, [{
    ...
    value: function render() {
      ...
      }, isWide && intoViewport ? children : null), _react["default"].createElement("div", {
        className: "demo-code"
      }, _react["default"].createElement(_CodePreview["default"], {
        title: title
      }, code)));
    }
  }]);
