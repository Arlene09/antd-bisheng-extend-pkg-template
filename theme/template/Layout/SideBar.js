...
function getComponentsMenuItem(menus) {
  var sortType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFUALT_SORTER_TYPE;
...
function getComponentsMenuGroups(data, componentOrder, sortType) {
  ...
  return menuGroups.map(function (item) {
    ...
    return _react["default"].createElement(MenuItemGroup, {
      key: category,
      title: category
...
function ComponentsMenu(props) {
  var _props$mode = props.mode,
      ...
      defaultOpenKeys = _props$defaultOpenKey === void 0 ? ['component'] : _props$defaultOpenKey,
  ...
  return (// eslint-disable-next-line max-len
    ...
    }, getArticlesMenu(docs), _react["default"].createElement(SubMenu, {
      title: "\u7EC4\u4EF6",
      key: "component"
    }, compCategoryOrder ? getComponentsMenuGroups(componentDatas, compCategoryOrder, compSorterType) : getComponentsMenuList(componentDatas, compSorterType)))
  );
}
